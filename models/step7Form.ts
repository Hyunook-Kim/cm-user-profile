 ...
 *
 * 데이터 출처: docs/figma_specs/7_추가정보/direct-analysis/
 */

// 사랑의 언어 옵션 (id, label, icon, description)
// description은 피그마 direct-analysis 기준
export const loveLanguageOptions = [
  {
    id: "qualityTime",
    label: "함께하는 시간",
    icon: "time-line",
    description: "연인이 나와 함께 집중해서 시간을 보낼 때",
  },
  {
    id: "actsOfService",
    label: "봉사",
  ...
  },
  {
    ...
    label: "스킨십",
    icon: "skinship-line",
    description: "사랑을 스킨십으로 표현해줄 때",
  },
  {
    id: "receivingGifts",
    label: "선물",
    icon: "gift-line",
    description: "연인이 의미가 있는 선물을 전해줄 때",
  },
];
...
export const step7Schema = z.object({
  ...
  // 메인화면 추천 희망 (원한다: want, 원하지 않는다: notWant)
  mainRecommendation: z.enum(["want", "notWant"]),

  // 같은 교회 이성 소개 희망 (원한다: want, 원하지 않는다: notWant)
